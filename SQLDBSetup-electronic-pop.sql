...
INSERT INTO song_collections (collectionTitle, collectionDate, genre, collectionDescription)
VALUES('Thumbelina', '2006', 'A ballet commissioned by the <a href="http://www.mwt.net/~marilynschoolofdance/MJDT.html" target="_blank" rel="noreferrer">Monroe-Jackson Dance Theatre of Central Wisconsin</a>. It was performed in the spring of 2007.
...
select collectionTitle, YEAR(collectionDate) as collectionDate from song_collections
